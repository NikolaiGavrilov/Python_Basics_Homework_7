...
# вариант решения через функцию внутри функции

# def print_operation_table(function, x_val = 6, y_val = 6):  
#     for i in range(1, x_val + 1):
#         table_list = []
#         for j in range(1, y_val + 1):
#             table_list.append(function(i, j))
#         print(*table_list)

# def function_multiplication (x_val, y_val):
#     return x_val * y_val
 
# print_operation_table(function_multiplication)


# # или так (через лямбду как в задании)
# ||
# \/
